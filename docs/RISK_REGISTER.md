...
|---|---|---:|---:|---:|---|---|---|---|---|---|
| RISK-2026-001 | 锚点无法稳定恢复，产品核心价值不成立 | 中 | 极高 | 高 | 页/区域指标未达标 | 阶段 0 金标与 parser/viewer 对照 | 降级格式/暂停产品开发 | 待定 | 阶段 0 | open |
...
| RISK-2026-005 | 模型/Prompt 更新造成静默质量退化 | 高 | 高 | 高 | eval、schema failure、cost 漂移 | 版本冻结、金标 gate、灰度 | 回退 model policy/prompt | 待定 | 阶段 2 | open |
