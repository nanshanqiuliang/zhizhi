...
| REQ-2026-010 / NFR-2026-002 / ADR-0001 | PDF 可视化渲染与锚点区域高亮 | WORK-2026-018 | pdfjs canvas + public worker；bbox 高亮层；file/anchors 端点 | `275d7c6` 红灯；`2601215` 实现；`d56e7ef` P1/P2 修复 | TC-RENDER-001..004 + 浏览器 e2e / TR-20260814-010：224/224、Web 20/20、窄视口 bbox aligned、QA FAIL→修复验证；文本层联动/多页滚动待后续 | — | render Runbook 待建 | prototype_verified |
