...
| REQ-2026-001 | 个人使用、本地优先 AI Agent App | WORK-2026-002/010 | PRD v0.3；ADR-0015/0016 | 待 WORK-2026-002 冻结提交 | 首版边界 10/10 映射待独立复核；实现/E2E 待建 | — | 用户手册待实现 | specified |
| REQ-2026-006..010 | Windows 单用户、本地核心可离线；首批 MD/TXT/PDF；人工确认/锁定；粒度；备份删除 | WORK-2026-002/005 及后续产品工作项 | PRD v0.3；ADR-0016 | 待 WORK-2026-002 冻结提交 | TC-PLAN-001..003 待执行；产品行为尚未实现 | — | 用户手册待实现 | specified |
