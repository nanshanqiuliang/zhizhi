...
| NFR-2026-002 | 数字 PDF 页级锚点 ≥98%，区域 ≥90% | WORK-2026-004/005 | calculus-gold.v1 eval fixture + independent-review.v1；Anchor v1 待建 | `e918fdf`、`232d0cd` | TC-DATA-001..006 / TR-20260813-003/004（50 个页级金标及复核覆盖已校验；真人复核/区域未完成） | — | RB-ANCH-001 待建 | partially_verified |
...
| NFR-2026-008 | DeepSeek 进入路由前有真实质量/成本/延迟证据 | WORK-2026-004/008 | calculus-gold.v1 输入已作者复核；independent-review.v1 完成门已建；capability snapshot + eval contract 待建 | `e918fdf`、`232d0cd`（仅 eval input/gate） | TR-20260813-003/004 CONDITIONAL GO；独立双签及 EVAL-LLM-001 待建 | — | Provider SLI 待建 | partially_verified |
