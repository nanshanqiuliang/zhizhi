...
| REQ-2026-006/008 / NFR-2026-001 | 冲突预览提示、数据损坏可从本地备份恢复 | WORK-2026-021 | `list_backups`/`restore_backup_by_name`（路径守卫）+ backups/restore 端点；前端错误码细化提示 + 备份/恢复入口 | `fb745bd` | TC-BACKUP-001..003 + Web 冲突/备份 2/2；全仓 246/246、Web 25/25；QA 待执行 | `docs/USER_MANUAL.md`（待更新） | DB/history Runbook 待建 | implemented |
