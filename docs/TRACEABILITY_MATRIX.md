...
| NFR-2026-005 | 发布可还原、构建可验证 | WORK-2026-006 | release manifest | — | RC clean build 待建 | — | RB-REL-001 待建 | planned |
| RISK-2026-004 | 遥测不得泄露敏感内容 | 待建 | telemetry catalog | — | security log test 待建 | — | RB-DIAG-001 待建 | planned |
| NFR-2026-006 | 多 LLM 不把厂商协议泄漏到领域层；首要兼容 DeepSeek | WORK-2026-007 | ADR-0013 / LLM compatibility v0.1 | — | TC-LLM-001..009 待建 | — | RB-PROV-001 draft | planned |
