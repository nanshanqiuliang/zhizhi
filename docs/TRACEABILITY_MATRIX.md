...
| NFR-2026-002 | 数字 PDF 页级锚点 ≥98%，区域 ≥90% | WORK-2026-004/005 | calculus-gold.v1 eval fixture；Anchor v1 待建 | `e918fdf` | TC-DATA-001..005 / TR-20260813-003（50 个页级金标已校验；区域未建） | — | RB-ANCH-001 待建 | partially_verified |
...
| NFR-2026-008 | DeepSeek 进入路由前有真实质量/成本/延迟证据 | WORK-2026-004/008 | calculus-gold.v1 输入已作者复核；capability snapshot + eval contract 待建 | `e918fdf`（仅 eval input） | TR-20260813-003 CONDITIONAL GO；EVAL-LLM-001 待建 | — | Provider SLI 待建 | partially_verified |
