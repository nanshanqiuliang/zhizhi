...
| WORK-2026-004 | 建立微积分金标集与许可清单 | 进行中 | 产品/学科+QA | 用户已指定 MIT OCW RES.18-001；独立复核者待定 | Chapter 2 PDF、dataset card、30 概念、40 关系、50 页级锚点 | 自动校验+作者复核进行中；独立复核待完成 |
...
`Gate A：阶段 -1 出口验收`。用户/项目负责人已批准本地工程骨架，并指定 MIT OCW RES.18-001 教材作为微积分资料；WORK-2026-004 已按第一轮动工顺序进入进行中。资料适用 CC BY-NC-SA 4.0，只允许非商业研发并要求署名/ShareAlike。独立学科复核、远端治理、许可证、核心 contract 和其余待决问题未完成前，不开始第 3 步或产品代码。
