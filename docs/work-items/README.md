...
当前产品主线：WORK-2026-005/011/012/013/014 已分别由 `TR-20260814-002/003/004/005/006` 验证。本地持久化闭环（SQLite 内核 + FastAPI sidecar + Web 自动保存）已完成；下一工作项进入第 4 步剩余能力（FTS5 搜索、文件导入）或第 5 步导入资料。Demo 与 prototype 不接真实 AI，不得把未实现能力宣称为已保存/已上线。
